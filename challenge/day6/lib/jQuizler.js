            ...
            return this.each(function(){
                ...
                $.each(questions, function(index, question){
                    ...
                    for (var i = 0; i < question.answers.length; i++)
                        html += "<li class=\"btn btn-default\">" + question.answers[i] + "</li>";
                ...
                html += "<div id=\"percent\" class=\"bar progress-bar progress-bar-info\" style=\"width: 0%;\"></div>";
                html += "</div>";
                ...
                $(".final").click(function(e){
                    ...
                    if (userAnswer.index() == -1 && !reviewQuiz) {
                        ...
                        resultHTML += "<p style=\"margin-top:25px; text-align: center\"><button class=\"btn btn-default tostart\">Просмотреть вопросы</button></p>";
                        resultHTML += "<p style=\"margin-top:25px; text-align: center\"> <button id = \"reset-test\" onclick=\"test()\" class=\"btn btn-default\">Начать заного</button>"
                        div.animate({
                            opacity : '0'
                        }, 500, function(e){
